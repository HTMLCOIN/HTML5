...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "Htmlcoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Htmlcoin is downloading blocks...");
    ...
    else
    {
        ...
        if(coinbase.size() == 0)
            ...
            CDataStream(coinbase, SER_NETWORK, PROTOCOL_VERSION) >> pblock->vtx[0]; // FIXME - HTML5!
